...
class ProcessShopifyOrdersJsonl implements ShouldQueue
{
    ...
    public function handle(ShopifyBulkFileDownloader $downloader, ShopifyOrderJsonlProcessor $processor): void
    {
        ...
        try {
            ...
            RecalculateAffectedSkuDemand::dispatch($run->id);

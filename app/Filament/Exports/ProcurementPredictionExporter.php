...
final class ProcurementPredictionExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        $columns = [
            ...
            'order_id_phase_1' => 'Order ID - Phase 1', 'eta_date_phase_1' => 'ETA Date - Phase 1',
            'quantity_on_order_phase_2' => 'Quantity On Order - Phase 2',
            'order_id_phase_2' => 'Order ID - Phase 2', 'eta_date_phase_2' => 'ETA Date - Phase 2',
            'quantity_on_order_phase_3' => 'Quantity On Order - Phase 3',
            'order_id_phase_3' => 'Order ID - Phase 3', 'eta_date_phase_3' => 'ETA Date - Phase 3',
            'total_quantity_on_order' => 'Total Quantity On Order',
            'total_confirmed_quantity_on_order' => 'Total Confirmed Quantity On Order',
